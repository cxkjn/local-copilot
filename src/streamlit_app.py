...
async def main() -> None:
    ...
    with st.sidebar:
        ...
        def architecture_dialog() -> None:
            st.image(
                "https://github.com/JoshuaC215/local-copilot/blob/main/media/agent_architecture.png?raw=true"
            )
            "[View full size on Github](https://github.com/JoshuaC215/local-copilot/blob/main/media/agent_architecture.png)"
            st.caption(
        ...
        "[View the source code](https://github.com/JoshuaC215/local-copilot)"
        st.caption(
    ...
    if len(messages) == 0:
        match agent_client.agent:
            case "code-assistant":
                WELCOME = "Hello! I'm local-copilot, your local code assistant. I can read, search, and edit files in the workspace, run commands, and answer questions. Ask me anything!"
            case _:
...
async def draw_messages(
    ...
    while msg := await anext(messages_agen, None):
        ...
        match msg.type:
            ...
            case "custom":
                # CustomData messages (see src/agents/utils.py CustomData)
                try:
